    ...
    settings = {
      bar = {
        ...
        memory = {
          ...
          "on-click" = "foot --app-id=htop -e htop";
        };
        backlight = {
          device = "amdgpu_bl0";
          "on-scroll-up" = "brillo -q - A 5 - u 300000";
          "on-scroll-down" = "brillo -q - U 5 - u 300000";
        ...
        clock = {
          ...
          "on-click" = "foot --title=clock --app-id=clock -e tty-clock -s -c -C 5";
        };
        battery = {
          states = {
            warning = 30;
